...
% Apply Forward Transform Code
coff = fwt_2d_marwan(0,img,4,h0);
figure(11);
colormap(gray(256));
affiche(coff);

% Apply Inverse Transform Code 
rec = fwt_2d_marwan(1,coff,4,h0);
figure(21);
affiche(rec);

% Add noise 
%sb=img+randn(256,256)*10;
% Use sb from previous section

wc = fwt_2d_marwan(0,sb,4,h0);
figure(12);
colormap(gray(256));
ptr2d(wc,4);

% My test images.
% They are normalized to [0 1] range
img1 = double(imread('ckb.jpg')) / 255; % camerana.tif
img2 = double(imread('chat.jpg')) / 255;
img3 = double(imread('eiffel.jpg')) / 255;
...
axis image; 
colormap gray;
title(['Result of Bilateral Filtering with w = ' num2str(w) ' and \sigma = ' num2str(sigma)] );

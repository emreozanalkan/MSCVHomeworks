function [ u,v ] = HSRefined( im1, im2, alpha, ite, uInitial, vInitial, displayFlow, displayImg )
%HSREFINED Summary of this function goes here
% Same function as HS, no difference at all
